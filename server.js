...
// Main Root Landing Page serves the complete theme architecture directly
app.get('/', (req, res) => {
...
<body><canvas id="waveCanvas"></canvas>
    ...
    <!-- LIVE HIGH-SPEED CHAT REDIRECT TO YOUR PERSONAL LINE -->
    <a href="https://wa.me." class="whatsapp-float" target="_blank">
        <svg class="whatsapp-icon" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
            <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.3 0 0 1-7.6 4.7 8.38 8.38 0 0 1-7.6-4.7 8.38 8.38 0 0 1 .9-3.8l-1.9-5.7 5.7 1.9a8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>
        </svg>
    </a>
    ...
    <div class="drawer-overlay" id="overlay" onclick="closeDrawer()"></div><div class="slide-drawer" id="drawer"><div class="drawer-handle" onclick="closeDrawer()"></div><h2 id="drawer-title">ROUTE CONFIGURATION</h2><form action="/submit-ticket" method="POST"><input type="hidden" name="serviceType" id="serviceTypeInput"><input type="hidden" name="platform" id="platformInput" value="INSTAGRAM"><label>CHOOSE PLATFORM NETWORK</label><div class="logo-grid"><div class="logo-item selected" onclick="selectPlatform(this,'INSTAGRAM')">INSTAGRAM</div><div class="logo-item" onclick="selectPlatform(this,'FACEBOOK')">FACEBOOK</div><div class="logo-item" onclick="selectPlatform(this,'TIKTOK')">TIKTOK</div><div class="logo-item" onclick="selectPlatform(this,'SNAPCHAT')">SNAPCHAT</div><div class="logo-item" onclick="selectPlatform(this,'YOUTUBE')">YOUTUBE</div><div class="logo-item" onclick="selectPlatform(this,'WHATSAPP')">WHATSAPP</div></div>
    
    <!-- RESTORED COMPLIANT TEXT INPUTS RE-ACTIVATES DRAWER LOGIC -->
