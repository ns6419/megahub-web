    ...
    const aiReq = https.request(opt, (aiRes) => {
        ...
        aiRes.on('end', () => { 
            try { 
                ...
                // FIXED PARSING LOGIC: Access arrays using explicit index references to prevent app engine crashes
