    ...
    const aiReq = https.request(opt, (aiRes) => {
        ...
        aiRes.on('end', () => { 
            try { 
                ...
                // Explicit array index configurations mapped out safely to fix the AI error completely
