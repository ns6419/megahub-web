    ...
    const aiReq = https.request(opt, (aiRes) => {
        ...
        aiRes.on('end', () => { 
            try { 
                ...
                // FIXED DATA ARRAY SELECTION: Adds precise zero index arrays to read Gemini JSON safely
