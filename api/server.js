    ...
    const aiReq = https.request(opt, (aiRes) => {
        ...
        aiRes.on('end', () => { 
            try { 
                ...
                // Array elements mapped explicitly to resolve parsing engine bugs
