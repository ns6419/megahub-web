    ...
    const aiReq = https.request(opt, (aiRes) => {
        ...
        aiRes.on('end', () => { 
            try { 
                ...
                // Fixed candidate structure mapping with precise array selectors to fix the AI error completely
