    ...
    const aiReq = https.request(opt, (aiRes) => {
        ...
        aiRes.on('end', () => { 
            try { 
                ...
                // Fixed JSON parsing structure to unpack the content parameters correctly
